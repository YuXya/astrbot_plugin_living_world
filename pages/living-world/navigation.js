...
export const PAGES = {
  ...
  context: { label: "上下文与提示词", tabs: { layout: "上下文排序", templates: "提示词模板", trial: "模型试跑", calls: "调用记录" } },
  ...
  sources: { label: "见闻与来源", tabs: { settings: "来源设置", records: "见闻记录", manual: "手动读取", runs: "日报执行" } },
  memory: { label: "记忆与日记", tabs: { records: "记忆与人物", journals: "日记与笔记", usage: "上下文用量" } },
