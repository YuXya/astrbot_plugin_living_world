...
OWNERS = {
    ...
    "task.date": ("context", "templates", "任务日期"),
    "task.parameters": ("context", "templates", "任务参数"),
    "task.reason": ("context", "templates", "任务原因与聊天意图"),
    ...
    "task.question": ("context", "templates", "本次问题与群消息"),
    ...
    "task.material": ("context", "templates", "本次任务材料"),
    "task.other": ("context", "templates", "其他任务资料"),
